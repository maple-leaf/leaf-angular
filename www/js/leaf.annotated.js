...
(function(IScroll, Swiper, window) {
    ...
    /**
        ...
        * @return {undefined}
    */
    leafUi.factory('leafPopup', ['$document', '$compile', '$rootScope', '$http', '$q', function($document, $compile, $rootScope, $http, $q) {
        return {
    ...
    leafUi.factory('leafScroll', ['$document', function($document) {
        return {
