...
(function(IScroll, Swiper, window) {
    ...
    */
    ...
    leafUi.factory('leafSidebar', ['$rootScope', '$timeout', function($rootScope, $timeout) {
        return {
    ...
    leafUi.directive('leafSlide', ['$timeout', function($timeout) {
        // <leaf-slider>
    ...
    leafUi.factory('leafPageload', ['$document', function($document) {
